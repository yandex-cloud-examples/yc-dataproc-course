module "s3-af-dataproc-infra" {
  source    = "../../modules/s3-bucket"
  folder_id = var.yc_folder_id
  bucket    = var.s3_bucket_dataproc_af
  ...
  "Statement": [
    {
      ...
      "Action": "*",
      "Resource": [
        "arn:aws:s3:::${var.s3_bucket_dataproc_af}/*",
        "arn:aws:s3:::${var.s3_bucket_dataproc_af}"
      ]
    },
    {
      ...
      "Condition" : {
        "StringLike" : {
          "aws:referer" : "https://console.yandex.cloud/folders/*/storage/buckets/${var.s3_bucket_dataproc_af}*"
        }
      },
      "Effect": "Allow",
      "Principal": "*",
